				...
				<div class=" flex w-full">
					...
					>
						<a
							...
							href="/endpoint/uivarpath/admin">{$i18n.t('Users')}</a
						>
						...
						<a
							class="min-w-fit rounded-full p-1.5 {$page.url.pathname.includes('/admin/evaluations')
								? ''
								: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
							href="/endpoint/uivarpath/admin/evaluations">{$i18n.t('Evaluations')}</a
						>
						...
						<a
							class="min-w-fit rounded-full p-1.5 {$page.url.pathname.includes('/admin/functions')
								? ''
								: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
							href="/endpoint/uivarpath/admin/functions">{$i18n.t('Functions')}</a
						>
						...
						<a
							class="min-w-fit rounded-full p-1.5 {$page.url.pathname.includes('/admin/settings')
								? ''
								: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
							href="/endpoint/uivarpath/admin/settings">{$i18n.t('Settings')}</a
						>
					</div>
				</div>
			</div>
